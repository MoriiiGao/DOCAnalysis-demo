...
class Format_converion_pdf2html():
    """
    ...
    def __init__(self, weights='/home/hello/gzc/3.project/yolov5-master/runs/train/exp3/weights/best.pt',  # model.pt path(s)
            ...
            dnn= False):
        super(Format_converion_pdf2html, self).__init__()
        ...
        self.upload_file_path = './static/AnalysisSystem/format_converion/html/upload_file/' + self.time + '/'
        self.upload_file_to_img_path = './static/AnalysisSystem/format_converion/html/pdf_to_img/' + self.time + '/'
        ...
        #html
        self.html = basepath + '/static/AnalysisSystem/format_converion/html/templates/' + self.time + '/'
        #压缩包
        self.pdf_and_html = './static/AnalysisSystem/format_converion/html/pdf_and_html/' + self.time + '/'
        self.zip = basepath + '/static/AnalysisSystem/format_converion/html/zip/'
    ...
    def pyMuPDF_fitz(self, PdfPath, ImagePath, html_path):
        ...
        with open(html_path + pdf_name + '.html', 'w', encoding='utf8') as f:
            f.write(HTMLstr)
        filename = pdf_name + '.html'

        return filename, HTMLstr
        # self.urlpath = self.url + html_path.split('.')[-1]
        # return {'code': 200, 'msg': 'succsee', 'data': self.urlpath}
